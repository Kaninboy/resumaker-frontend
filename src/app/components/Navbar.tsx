    ...
    <nav className="sticky top-0 left-0 right-0 bg-basebg z-50">
      <Flex minWidth="max-content" alignItems="center" py="16px">
        ...
        <ButtonGroup gap="22px">
          <Button variant="link" colorScheme="primary" onClick={onLoginOpen}>
            Login
          </Button>
          <Modal isCentered isOpen={isLoginOpen} onClose={onLoginClose}>
            <ModalOverlay />
            <ModalContent>
              <ModalHeader fontSize="18px" pb="4px">Login</ModalHeader>
              <ModalCloseButton />
              <ModalBody fontSize="14px" fontWeight="600" pt="4px">
                Join
                <Text as="span" color="primary.500">
                  &nbsp;RESUMAKER&nbsp;
                </Text>
                and build your resume in seconds!
              </ModalBody>
              <Button size="sm" m="24px" mt="4px" colorScheme="primary" variant="outline">
                Continue with Google
              </Button>
            </ModalContent>
          </Modal>
          <Button colorScheme="primary" onClick={onSignUpOpen}>Sign Up</Button>
          <Modal isCentered isOpen={isSignUpOpen} onClose={onSignUpClose}>
            <ModalOverlay />
            <ModalContent>
              <ModalHeader fontSize="18px" pb="4px">Sign Up</ModalHeader>
              <ModalCloseButton />
              <ModalBody fontSize="14px" fontWeight="600" pt="4px">
                Join
                <Text as="span" color="primary.500">
